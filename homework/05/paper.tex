...
%Recall that $l_i(x) = \displaystyle\prod_{\substack{j = 0 \\ j \neq i}}^n \displaystyle\frac{x-x_j}{x_i - x_j}$, so $l_i' = \displaystyle\sum_{\substack{j = 0 \\ j \neq i}}^n \displaystyle\frac{1}{x_i - x_j}$
